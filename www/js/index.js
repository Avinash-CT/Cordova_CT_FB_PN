...
//     // cordova.plugins.firebase.onMessageReceived(function(payload){
//     //     console.log("PASSED");
//     // });
...
onCleverTapPushNotificationTappedWithCustomExtras: function(e) {
    ...
    //to get full payload in kv pairs in alert
    // alert(JSON.stringify(e.customExtras))

    //to get only value
    //where key is "avinash"
    var obj;
    obj = e.customExtras;
    alert(obj.avinash);
},
